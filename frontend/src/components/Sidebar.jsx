...
<div class=" fixed  bg-white dark:bg-blue-950">
    <div class="flex flex-col sm:flex-row sm:justify-around">

        <div className=' py-6  font-light flex flex-col gap-5 bg-[#0f172a]  '>
            <a href="" className='flex flex-col justify-center hover:bg-blue-950'>
            ...
            <a href="" className='flex flex-col justify-center  items-center  hover:bg-blue-950'>
...
Team
        ...
        <div class="h-screen w-60">
            <h2 className='font-bold text-center m-5'>CRM EMPLOYEE</h2>
            <nav class="mt-10  ">
                <a class="hover:text-gray-800 hover:bg-gray-100 flex items-center p-2  transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200  text-gray-600 dark:text-gray-400 rounded-lg " href="#">
                    <span class="mx-4 text-lg font-normal">
                        Element
                    </span>
      
                </a>
                <a class="hover:text-gray-800 hover:bg-gray-100 flex items-center p-2  transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200  text-gray-800 dark:text-gray-100 rounded-lg" href="#">
                    <span class="mx-4 text-lg font-normal">
                        Form
                    </span>
