...
<div className=" fixed z-10 h-full  bg-[#362e69]">
    <div className="flex flex-col sm:flex-row ">

        <div className=' py-10 font-light flex flex-col gap-1 bg-[#0e0f4b]  '>
            <NavLink to="/services" className={({ isActive })=>` ${isActive? "bg-[#362e69]": ""} flex flex-col p-2 justify-center hover:bg-[#362e69]`}>
            ...
            <NavLink to="/home" className={({ isActive })=>` ${isActive? "bg-[#362e69]": ""} flex flex-col p-2 justify-center hover:bg-[#362e69]`}>
            ...
            <NavLink to="/team" className={({ isActive }) =>  `${isActive ? "bg-[#362e69]" : ""} flex flex-col p-2 justify-center hover:bg-[#362e69]`}>
